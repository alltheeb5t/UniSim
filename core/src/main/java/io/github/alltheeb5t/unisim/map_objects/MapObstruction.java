 ...
 * Map Object Extends Scene2D Image since all objects will invariably involve an image asset
 */
public class MapObstruction extends Image {
     ...
     * @param texture
     */
    public MapObstruction(float x, float y, float width, float height, World world, Texture texture) {
        super(texture); // Superclass is Scene2D Image
     ...
     * @param texture
     */
    public MapObstruction(float x, float y, float width, World world, Texture texture) {
